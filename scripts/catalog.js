...
async function main(){
  ...
  function showDetail(id){
    ...
    c.innerHTML='';
    const back=document.createElement('a'); back.href='#'; back.className='close'; back.textContent='×'; back.addEventListener('click',e=>{e.preventDefault();location.hash='';}); c.appendChild(back);
